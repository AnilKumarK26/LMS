...
const MachineLearningExamDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const mlAttempt = data.progress.find(attempt => attempt.examName === 'Machine Learning'); // Change to ML
        console.log(mlAttempt);
        setExamData(mlAttempt);
  ...
  return (
    <div className="dashboard-container">
      <h2 className="dashboard-title">Machine Learning Exam Dashboard</h2> {/* Change title */}
...
export default MachineLearningExamDashboard;
